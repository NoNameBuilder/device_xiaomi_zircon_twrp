...
# Building with minimal manifests
...
# TWRP Brightness and Configuration
...
TW_INCLUDE_LTW_EXTRA_LANGUAGES := true
TW_DEFAULT_LANGUAGE := en-USPTOOLS := true
TW_EXCLUDE_APEX := true
TW_INCLUDE_NTFS_3G := true
TW_INCLUDE_FUSE_EXFAT := true

# UI
TW_DEVICE_VERSION := Note 13 Pro+ | Dumi
...
# Recovery partition configurations
